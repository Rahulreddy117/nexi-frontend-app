...
export default function BlockedUsersScreen() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const [token, parseId] = await Promise.all([
  ...
  const handleUnblock = async (blockedAuth0Id: string) => {
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={[styles.emptySubtitle, { color: colors.secondaryText }]}></Text>
    </View>
  );
      ...
      <View style={[styles.userItem, { borderBottomColor: colors.border }]}>
        <View style={styles.userInfo}>
          ...
          <View style={styles.userTextContainer}>
            ...
            <Text style={[styles.blockedLabel, { color: colors.primary }]}>Blocked</Text>
          </View>
        </View>

        <TouchableOpacity
          onPress={() => handleUnblock(item.auth0Id)}
          style={[styles.unblockBtn, { backgroundColor: colors.card }, isUnblocking && styles.unblockBtnDisabled]}
          activeOpacity={0.7}
    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
        ...
        <View style={styles.loadingContainer}>
          ...
          <Text style={[styles.loadingText, { color: colors.primary }]}>Loading blocked users...</Text>
        </View>
      </SafeAreaView>
    );
  }
...
const styles = StyleSheet.create({
  ...
  headerSpacer: { width: moderateScale(32) },
  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  loadingText: { marginTop: hp('2%'), fontSize: moderateScale(15), fontWeight: '500' },
  ...
  emptyTitle: { fontSize: moderateScale(22), fontWeight: '700', marginBottom: hp('1%'), textAlign: 'center' },
  emptySubtitle: { fontSize: moderateScale(15), textAlign: 'center', lineHeight: moderateScale(22) },
  ...
  userInfo: { flexDirection: 'row', alignItems: 'center', flex: 1, gap: wp('3%') },
  avatar: { width: moderateScale(52), height: moderateScale(52), borderRadius: moderateScale(26) },
  avatarPlaceholder: {
  ...
  userTextContainer: { flex: 1, gap: hp('0.3%') },
  username: { fontSize: moderateScale(16), fontWeight: '600' },
  blockedLabel: { fontSize: moderateScale(13), fontWeight: '500' },
  unblockBtn: {
    paddingHorizontal: wp('5%'),
  ...
  unblockText: { fontSize: moderateScale(14), fontWeight: '700' },
});